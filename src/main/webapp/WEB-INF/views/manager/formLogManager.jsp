...
<head>
    ...
    <title>Connexion Manager - BusinessSuite</title>
    <style>
    ...
    <div class="container">
        <div class="login-card">
            <div class="login-header">
                <h1 class="login-title">Connexion Manager</h1>
                <p class="login-subtitle">Accès réservé aux responsables d'équipe</p>
            </div>

            <form action="logManager" method="post" class="login-form">
                <div class="form-group">
                    <label for="nom">Nom d'utilisateur</label>
                    <input type="text" id="nom" name="nom" value="Manager" required>
                </div>

                <div class="form-group">
                    <label for="motDePasse">Mot de passe</label>
                    <input type="password" id="motDePasse" name="motDePasse" value="mdp123" required>
                </div>
