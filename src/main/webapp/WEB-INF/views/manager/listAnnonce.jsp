...
<body>
    ...
    <a href="${pageContext.request.contextPath}/accueilManager">retour</a>
    ...
    <c:forEach var="annonce" items="${annonces}">
        <div style="border:1px solid #ccc; padding:10px; margin:10px 0;">
            ...
            <a href="${pageContext.request.contextPath}/supprimerAnnonce?id=${annonce.id}">Supprimer l'annonce</a>
            <br><a href="${pageContext.request.contextPath}/updateAnnonce?id=${annonce.id}">Modifier l'annonce</a>
        </div>
    </c:forEach>
</body>
