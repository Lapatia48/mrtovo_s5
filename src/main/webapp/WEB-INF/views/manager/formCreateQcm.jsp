...
<head>
    ...
    <title>Créer QCM - AnnoncesManager</title>
    ...
    <div class="admin-layout">
        ...
        <div class="main-content">
            <div class="top-header">
                <h1 class="page-title">Création de QCM</h1>
                <div class="user-menu">
            ...
            <div class="content-area">
                <div class="form-card">
                    <div class="form-header">
                        <h2 class="form-title">Nouveau Questionnaire</h2>
                        <p class="form-subtitle">Créez un nouveau QCM avec ses questions et réponses</p>
                    </div>
                    ...
                    <form action="${pageContext.request.contextPath}/manager/insertQcm" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" id="question" name="question" placeholder="Entrez la question du QCM" required>
                            </div>
                        </div>
                            ...
                            <div class="reponses-section">
                                <div id="reponses-container">
                                    ...
                                    <div class="reponse-item">
                                        <input type="text" class="reponse-input" name="reponses" placeholder="Réponse 1" required>
                                        <div class="radio-group">
                                            <input type="radio" name="reponse_correcte" value="0" required>
                                            <span>Correcte</span>
                                        </div>
                                    </div>
                                    <!-- Réponse 2 -->
                                    <div class="reponse-item">
                                        <input type="text" class="reponse-input" name="reponses" placeholder="Réponse 2" required>
                                        <div class="radio-group">
                                            <input type="radio" name="reponse_correcte" value="1" required>
                                            <span>Correcte</span>
                                        </div>
                                    </div>
                                    <!-- Réponse 3 -->
                                    <div class="reponse-item">
                                        <input type="text" class="reponse-input" name="reponses" placeholder="Réponse 3" required>
                                        <div class="radio-group">
                                            <input type="radio" name="reponse_correcte" value="2" required>
                                            <span>Correcte</span>
                                        </div>
                                        <button type="button" class="delete-btn" onclick="supprimerReponse(this)" style="display: none;">
    ...
    <script>
        ...
        function ajouterReponse() {
            ...
            div.innerHTML = `
                ...
                <div class="radio-group">
                    <input type="radio" name="reponse_correcte" value="${reponseCount - 1}" required>
                    <span>Correcte</span>
                </div>
            ...
            // Afficher les boutons de suppression pour toutes les réponses sauf les 2 premières
