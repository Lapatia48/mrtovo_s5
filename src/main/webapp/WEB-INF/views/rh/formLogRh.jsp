    ...
    <div class="container">
        <div class="login-card">
            <div class="login-header">
                <h1 class="login-title">Connexion RH</h1>
                <p class="login-subtitle">Accès réservé aux ressources humaines</p>
            </div>

            <form action="logRh" method="post" class="login-form">
                <div class="form-group">
                    <label for="nom">Nom d'utilisateur</label>
                    <input type="text" id="nom" name="nom" value="ressource humaine" required>
                </div>

                <div class="form-group">
                    <label for="motDePasse">Mot de passe</label>
                    <input type="password" id="motDePasse" name="motDePasse" value="mdprh123" required>
                </div>
