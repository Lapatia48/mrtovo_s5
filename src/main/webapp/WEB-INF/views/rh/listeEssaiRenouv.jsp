...
<head>
    <meta charset="UTF-8">
    <title>Renouvellement d'Essai - BusinessSuite RH</title>
    <style>
        ...
        * {
        ...
        /* Tableau des candidats en renouvellement */
        .table-container {
            background: var(--white);
            border-radius: var(--border-radius);
            box-shadow: var(--box-shadow);
...
<body>
    <div class="admin-container">
        ...
        <nav class="sidebar">
            ...
            <div class="nav-menu">
                ...
                <div class="nav-item">
                    <a href="${pageContext.request.contextPath}/rh/essaiRenouv" class="nav-link active">
        ...
        <main class="main-content">
            ...
            <div class="top-bar">
                <div class="page-title">
                    ...
                    <p>Gestion des candidats en renouvellement de période d'essai</p>
                </div>
                <div class="user-menu">
            ...
            <div class="filter-section">
                <h3><i class="fas fa-filter"></i> Filtres des candidats en renouvellement</h3>
            ...
            <div class="table-container">
                <div class="table-header">
                    <h3>Liste des candidats en renouvellement d'essai</h3>
                    <div class="table-count" id="resultCount">
                        ${essaiDetails.size()} candidat(s) en renouvellement
                    </div>
                </div>
                        ...
                        <c:forEach var="e" items="${essaiDetails}">
                            <tr>
                                ...
                                <td class="actions-cell">
                                    ...
                                    <a href="${pageContext.request.contextPath}/renouv/embauche?id_cand=${e.idCandidat}" class="action-link success" title="Embaucher définitivement">
                                        <i class="fas fa-user-check"></i>
                                        Embaucher
                                    </a>
                                    <a href="${pageContext.request.contextPath}/essai/refuseRenouv?id_cand=${e.idCandidat}" class="action-link danger" title="Refuser le candidat">
                                        <i class="fas fa-user-times"></i>
                                        Refuser
                                    </a>
                                </td>
                ...
                <div id="noResults" class="no-results" style="display: none;">
                    ...
                    <h3>Aucun candidat en renouvellement trouvé</h3>
    ...
    <script>
        // Le script JavaScript adapté pour le renouvellement d'essai
        ...
        function filterTable() {
            ...
            document.getElementById('resultCount').textContent = visibleCount + ' candidat(s) en renouvellement';
