...
<head>
    <meta charset="UTF-8">
    <title>Liste des candidats en periode de renouvellement d'essai</title>
</head>
<body>
    <p style="color: green;">${success}</p>
    <h2>Liste des candidats en periode de renouvellement d'essai</h2>
    <a href="${pageContext.request.contextPath}/accueilRh">Retour</a>

    <!-- Section Filtres -->
    <div class="filter-section">
        <h3>Filtres des candidats en renouvellement essai</h3>
            ...
            <tbody id="candidatsBody">
                <c:forEach var="e" items="${essaiDetails}">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/renouv/embauche?id_cand=${e.idCandidat}">Embaucher</a></td>
                        <td><a href="${pageContext.request.contextPath}/essai/refuseRenouv?id_cand=${e.idCandidat}">refuser</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
