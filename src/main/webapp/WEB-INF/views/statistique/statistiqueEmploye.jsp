...
<body>
    <div class="admin-container">
        ...
        <main class="main-content">
            ...
            <div class="filter-section">
                <h2>Nombre employe par âge</h2>

                <canvas id="birthYearChart" width="400" height="200"></canvas>
            </div>

            <div class="filter-section">
                <h2>Répartition des employés par département</h2>

                <canvas id="departementChart" width="600" height="300"></canvas>
            </div>
    ...
    <script>
        const years = [<c:forEach var="y" items="${years}"> "${y}", </c:forEach>];
        const yearCounts = [<c:forEach var="c" items="${counts}"> ${c}, </c:forEach>];
    ...
    <script>
        const departements = [<c:forEach var="d" items="${departements}"> "${d}", </c:forEach>];
        const departementCounts = [<c:forEach var="c" items="${countsDepartements}"> ${c}, </c:forEach>];
