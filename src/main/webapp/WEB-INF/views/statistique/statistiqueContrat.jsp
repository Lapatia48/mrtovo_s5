...
<body>
    <div class="admin-container">
        ...
        <main class="main-content">
            ...
            <!-- Section liste contract expirés-->
            <div class="table-container">
                <h2>Contrats expirant dans les 2 prochains mois</h2>
                ...
                <table class="data-table">
                    ...
                    <c:forEach var="c" items="${contracts}">
                        <tr>
                            <td>${c.nom}</td>
                            <td>${c.prenom}</td>
                            <td>${c.posteContrat}</td>
                            <td>${c.departement}</td>
                            <td>${c.typeContrat}</td>
                            <td>${c.dateDebut}</td>
                            <td class="fw-bold text-danger">${c.dateFin}</td>
                            <td>${c.salaireBase}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
            ...
            <div class="table-container" style="margin-top: 40px;">
                <h2>Congés Restants par Employé</h2>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <c:forEach var="row" items="${leaves}">
                            <tr>
                                <td>${row[0]}</td>
                                <td>${row[1]}</td>
                                <td>${row[2]}</td>
